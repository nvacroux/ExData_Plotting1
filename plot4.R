...
# This code block creates the plot in the upper left quadrant.
# This code is substantially identical to that creating plot2.
plot(type="l", subdata$Time, subdata$Global_active_power, xlab="", ylab="Global ActivePower")

# This code creates the plot in the lower left quadrant.
# This code is identical to that creating plot3.
...
# This code creates the plot in the upper right quadrant.
plot(subdata$Time, subdata$Voltage, type="l", ylab="Voltage", xlab="datetime")

# This code creates the plot in the lower right quadrant.
